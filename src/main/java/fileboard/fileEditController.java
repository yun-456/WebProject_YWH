...
//수정하기
@WebServlet("/fileboard/fileedit.do")
@MultipartConfig(
...
public class fileEditController extends HttpServlet{
   ...
   protected void doGet(HttpServletRequest req, 
      ...
      req.getRequestDispatcher("/fileboard/fileEdit.jsp").forward(req, resp);
   }
   ...
   protected void doPost(HttpServletRequest req, 
      ...
      if (result == 1) { //수정 성공
         ...
         resp.sendRedirect("../fileboard/fileview.do?idx=" + idx);
      }
      else { //수정 실패 : 경고창을 띄운다.
         JSFunction.alertLocation(resp, "비밀번호 검증을 다시 진행해주세요.", 
            "../fileboard/fileview.do?idx=" + idx);
      }
   }
}
